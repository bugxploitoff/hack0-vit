                ...
                <div className="flex flex-wrap pb-10">
                    <div className="px-6 pb-5">
                        <a className="text-blue-300 lg:text-xl text-md font-firaCode flex flex-wrap space-x-3 ">
                            ...
                            <h1 className="font-firaCode font-semibold lg:text-xl text-md"><span className="text-green-300 inline">200 OK </span><span className="inline text-blue-800">git:(</span><span className="inline text-red-600">master</span><span className="text-blue-800">)</span> $ <span className="inline-block text-white">./validation.sh</span></h1>
                        </a>
                        
                    </div>
                    <div className="w-1/2 lg:w-2/3 mx-auto  self-center lg:px-10 px-6 pb-5 pt-10">
                        <Image src={"/assets/succ.png"} width={400} height={400} alt="Error" className="rounded-lg "/>
                    </div>
                </div>
